...
N_EULER_SIMULATION *new_n_fluid( double density , size_t sx , size_t sy , size_t sz , double h )
{
    ...
    fluid_sim -> u    = new Float32Array(this.numCells);
    fluid_sim -> newU = new Float32Array(this.numCells);

    fluid_sim -> v    = new Float32Array(this.numCells);
    fluid_sim -> newV = new Float32Array(this.numCells);

    fluid_sim -> p    = new Float32Array(this.numCells);
    fluid_sim -> s    = new Float32Array(this.numCells);

    fluid_sim -> m    = new Float32Array(this.numCells);
    fluid_sim -> newM = new Float32Array(this.numCells);

    return fluid_sim ;
} /* new_n_fluid */


int integrate(dt, gravity) {
    var n = this.numY;
